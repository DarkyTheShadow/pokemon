            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="flex-1 flex flex-row">
                        <div class="w-1/4">
                            <img src="https://assets.pokemon.com/assets/cms2/img/pokedex/full/<?php echo \str_pad($card['picture'], 3, '0', \STR_PAD_LEFT); ?>.png" alt="<?php echo \htmlspecialchars($card['name']); ?>" class="w-full h-64 object-contain">
                        </div>
                        <div class="w-1/2 pl-4">
                            ...
                            <p class="text-2xl font-bold text-blue-600 mb-4">€ <?php echo \number_format($card['price'], 2, ',', ''); ?></p>
                            <p>
